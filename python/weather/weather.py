...
r = requests.get('https://' + USERNAME + ':' + PASSWORD + '@twcservice.mybluemix.net/api/weather/v3/location/search', params=payload)
...
################################################################################
r = requests.get('https://' + USERNAME + ':' + PASSWORD + '@twcservice.mybluemix.net/api/weather/v1/geocode/' + str(lat) + '/' + str(lon) + '/forecast/daily/7day.json')
...
################################################################################
payload = {'hours': 23}
r = requests.get('https://' + USERNAME + ':' + PASSWORD + '@twcservice.mybluemix.net/api/weather/v1/geocode/' + str(lat) + '/' + str(lon) + '/observations/timeseries.json', params=payload)
...
print('________________________________ ' + str(max_temp) + '° ________________________________')
for y in chart:
    if y == 0:
        ...
        for x in y:
            if x == 0:
                ...
                print('***', end='')
        print()
print('________________________________ ' + str(min_temp) + '° ________________________________')
